        ...
        <div className="max-md:top-0 max-md:bottom-0 max-md:right-0 max-md:left-0 max-md:h-full max-md:max-h-full flex justify-center max-h-20 fixed bottom-0 bg-senary-color right-0 left-0">
            ...
            <div className="flex justify-center py-2 max-w-[500px] max-md:justify-center max-md:items-center max-md:flex-col max-md:gap-5">
                ...
                <div className=" flex flex-col justify-center items-center text-white max-md:gap-5">
                    <span className="flex gap-2 items-center max-md:text-3xl"><GiLoveSong />{currentSong?.Song?.title}</span>
                    <div className="w-full h-full">
                        <audio onEnded={handleEnd} onPlay={handlePlay} onPause={handlePause} className="scale-75 custom-audio max-md:scale-100" controls src={currentSong?.Song?.url} />
                    </div>
                </div>
                {/* ---------------- */}
            </div>
